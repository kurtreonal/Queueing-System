...
<meta charset="UTF-8">
    ...
    <meta name="author" content="Contact Page designer (Pascua) - Group RedRivon">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<div id="container">
  ...
  <form action="connection.php" method="POST" id="contact_form">
    <div class="name">
    ...
    <div class="telephone">
      <label for="name"></label>
      <input type="text" placeholder="Phone Number" name="phone" id="telephone_input" required>
    </div>
    <div class="subject">
    ...
    <div class="submit">
        <input type="submit" name="savecontact" value="Send Message" id="form_button" />
    </div>
  </form><!-- // End form -->
</div><!-- // End #container -->
</body>
